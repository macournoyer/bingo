...
function generatesPreStringToken(name){
...
lexer.addRule(/\:/, generatesPreStringToken("COLON"))
lexer.addRule(/(is|equals|=)/, generatesPreStringToken("EQ"))
lexer.addRule(/(<|>)\=?/, generatesPreStringToken("COMP"))
...
lexer.addRule(/else/, generatesToken("ELSE"))
lexer.addRule(/end/, generatesToken("END"))
lexer.addRule(/times/, generatesToken("TIMES"))
lexer.addRule(/every/, generatesToken("EVERY"))
lexer.addRule(/(gets)/, generatesToken("GETS"))
lexer.addRule(/(exit|quit)/, generatesToken("EXIT"))
